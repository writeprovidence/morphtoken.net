...
contract Morphtoken {                     //this is a smart contract!
    
    address owner;                       //which account gets the tokens to begin with
    mapping (address => uint) Morphs[];  //keep track of the number of tokens in each account
